...
- [ ] Confirm MP3 recordings open from GitHub.
- [ ] Confirm markdown links in `CALL_INDEX.md` and `BUG_REPORT.md` work on GitHub.
- [ ] Confirm top-level `README.md`, `ARCHITECTURE.md`, `REQUIREMENTS_AUDIT.md`, `VOICE_QUALITY_REVIEW.md`, `CALL_INDEX.md`, `BUG_REPORT.md`, `LOOM.md`, and this checklist are visible at repo root.
